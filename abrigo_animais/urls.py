...
from abrigo_animais.views import pagina_inicial, card_animais, pedido_adocao, pesquisar_animais, status, sobre, fale_conosco


urlpatterns = [
    path("", pagina_inicial, name='Abrigo_de_Animais'),
    path("animais/<int:id>", card_animais, name='Card_de_Animais'),
